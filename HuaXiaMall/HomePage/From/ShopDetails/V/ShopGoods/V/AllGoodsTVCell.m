...
- (void)setCreatingControls {
    ...
    self.showImage.sd_layout.leftSpaceToView(self.contentView, 12).topSpaceToView(self.contentView, 15).bottomSpaceToView(self.contentView, 15).widthIs(kScreen_widht *0.346667).autoHeightRatio(0.93);
    ...
    self.nameLabel.sd_layout.leftSpaceToView(self.showImage, 17).topSpaceToView(self.contentView, 30).heightIs(20).rightSpaceToView(self.contentView, 15);
    ...
    self.priceLabel.sd_layout.leftSpaceToView(self.showImage, 17).topSpaceToView(self.nameLabel, 20).heightIs(20).rightSpaceToView(self.contentView, 15);
    
    self.originalPriceLabel = [UILabel new];
    NSAttributedString *attrStr =
    [[NSAttributedString alloc]initWithString:@"￥:699.00"
                                   attributes:
    ...
    [self.contentView addSubview:self.AwardPointsLabel];
    ...
    self.heatLabel.sd_layout.rightSpaceToView(self.contentView,12).topSpaceToView(self.originalPriceLabel, 15).heightIs(7).widthIs(kScreen_widht/3);
     [self setupAutoHeightWithBottomView:self.showImage bottomMargin:15];
