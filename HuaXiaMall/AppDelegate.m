...
#define NAVI_TEST_APP_KEY   @"2lP2VbGOgwQHjtGOFVDPrG4bBLSj7Sdu"//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"firstLaunch"]){
        ...
        PublicTabBarViewController *VC = [[PublicTabBarViewController alloc] init];
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HuaXiaMall" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"HuaXiaMall.sqlite"];
    NSError *error = nil;
