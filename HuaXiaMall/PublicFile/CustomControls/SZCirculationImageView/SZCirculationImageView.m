...
- (UIView *)titleView {
    ...
    if (_titleView == nil) {
        ...
        if (self.titleViewStatus == SZTitleViewTopOnlyTitle) {
            ...
            _titleView.backgroundColor = MColor(134, 134, 134);
            ...
            _PageNumber.textColor = MColor(255, 255, 255);
        ...
        if(prect.size.width != 0) {
            ...
            self.pageControl.currentPageIndicatorTintColor = kNavigation_Color;
...
- (CGRect)setupPageControlFrame:(CGRect *)frame titleLabelFrame:(CGRect *)titleFrame {
    ...
    switch (self.titleViewStatus) {
        ...
        case SZTitleViewTopOnlyTitle:
            rect = CGRectMake(kScreen_widht-kFit(64), kFit(237), kFit(53), kFit(53));
