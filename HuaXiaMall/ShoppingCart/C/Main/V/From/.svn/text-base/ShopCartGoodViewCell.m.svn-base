...
- (void)layoutSubviews{
    ...
    _colorTypeLabel.y = kFit(10) + CGRectGetMaxY(_goodNameLabel.frame);
...
- (void)setModel:(ShopCartModel *)model{
    ...
    [_goodsImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",kImage_URL, model.goods_image_url]] placeholderImage:[UIImage imageNamed:@"zly"]];
    _goodNameLabel.text = @"1234567上山打灰机 7654321 1234567上山打灰机 7654321";
